...
def load_arguments(dataset=None):
    ...
    argparser.add_argument("--use_windows",
                           type=int,
                           choices=[0, 1],
                           default=0,
                           help="run on windows or not")
    argparser.add_argument("--attack_model",
                           type=str,
                           choices=['mutil', 'single','bae'],
                           default='single',
                           help="multi attack or single attack")
    argparser.add_argument("--mlm_model",
                           type=str,
                           #choices=['bert-base-uncased','albert-base-v2', 'distilroberta-base','roberta-base', 'roberta-large',''],
                           default='distilroberta-base',
                           help="select the MLM model to fill the [MASK]")
    argparser.add_argument("--prompt_target",
                        type=str,
                        choices=['target', 'ori'],
                        default=r'ori',
                        help="Target attack or ori attack")
    argparser.add_argument("--read_num",
                        type=int,
                        default=1000,
                        help="read number of samples")
    argparser.add_argument("--use_prompt",
                        type=int,
                        default=1,
                        help="use prompt or not ")
    argparser.add_argument("--prompt_template",
                        type=str,
                        default="{0} news:",
                        help="prompt_template")
    argparser.add_argument("--prompt_location",
                        type=str,
                        choices=['front','rear','both','sent','sent_r','sent_f'],
                        default='front',
                        help="prompt_location front or rear")

    argparser.add_argument("--model_idx",
                        type=int,
                        help="attack model type idx")
    ...
    argparser.add_argument("--target_model",
                        ...
                        default=r'bert-base-uncased-ag-news',
    ...
    argparser.add_argument("--USE_cache_path",
                        type=str,
                        default='./tmp',
                        #default=   r'C:\Users\Rafael\AppData\Local\Temp\tfhub_modules',
    ...
    argparser.add_argument("--counter_fitting_embeddings_path",
                        type=str,
                        default='otherModels/counter-fitted-vectors.txt',
                        help="path to the counter-fitting embeddings we used to find synonyms")
    argparser.add_argument("--counter_fitting_cos_sim_path",
                        type=str,
                        default='otherModels/cos_sim_counter_fitting.npy',
    ...
    argparser.add_argument('--target_model_name',
                        type=str,
                        default="bert-base-uncased-ag-news",
